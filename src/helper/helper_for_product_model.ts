...
function convert_ids_to_sql_list(
  list: [product_id: number, quantity: number][] | undefined
): number[] {
  if (list === undefined)
...
function check_if_product_is_missing(
  product_list: Product[],
  converted_list: string
): boolean {
