...
describe('User Model', function () {
    it('should have an signup method', function () {
    ...
    it('signup method should create a new user', function () { return __awaiter(void 0, void 0, void 0, function () {
        var result;
    ...
    it('signin method should return a user', function () { return __awaiter(void 0, void 0, void 0, function () {
        var result;
        return __generator(this, function (_a) {
            switch (_a.label) {
    ...
    it('signin method should return a null (Wrong password)', function () { return __awaiter(void 0, void 0, void 0, function () {
        var result;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, user.signin('abcd@efg.hi', '1235')];
                case 1:
                    result = _a.sent();
