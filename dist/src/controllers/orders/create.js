...
var create = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var _a, user_id, products_list, order, error_1, err;
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                console.log('create new order');
                _a = req.body, user_id = _a.user_id, products_list = _a.products_list;
                _b.label = 1;
            case 1:
                _b.trys.push([1, 3, , 4]);
                if (!user_id)
                ...
                if (!products_list)
                    throw new Error("Error: products_list is mandatory for creating the order");
