...
var signin = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var _a, email, password, user, token, error_1, err;
    return __generator(this, function (_b) {
        switch (_b.label) {
            ...
            case 1:
                _b.trys.push([1, 3, , 4]);
                if (!email)
                    throw new Error("Error: email is mandatory for login the user");
                if (!password)
                    throw new Error("Error: password is mandatory for login the user");
                return [4 /*yield*/, User.signin(email, password)];
            case 2:
                user = _b.sent();
                if (user === null)
