...
var create = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var category_name, categores, error_1, err;
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                _a.trys.push([1, 3, , 4]);
                if (!category_name)
                    throw new Error("Error: category_name is mandatory for creating the category");
                return [4 /*yield*/, category.create(category_name)];
            case 2:
                categores = _a.sent();
                return [2 /*return*/, res.status(200).json({ status: true, msg: 'Done', categores: categores })];
            case 3:
                error_1 = _a.sent();
