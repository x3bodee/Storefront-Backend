...
var CategoryModel = /** @class */ (function () {
    ...
    CategoryModel.prototype.show = function (id) {
        return __awaiter(this, void 0, void 0, function () {
    ...
    CategoryModel.prototype.create = function (name) {
        return __awaiter(this, void 0, void 0, function () {
            var conn, sql1, select_result, sql2, insert_result, err_3;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 4, , 5]);
                    ...
                    case 1:
                        conn = _a.sent();
                        sql1 = 'select category_name from category where category_name= ($1);';
                        return [4 /*yield*/, conn.query(sql1, [name])];
                    case 2:
                        select_result = _a.sent();
                        if (select_result.rows[0])
                            throw new Error("Error: This record alredy exist!!");
                        sql2 = 'insert into category (category_name) values ($1) RETURNING *;';
                        return [4 /*yield*/, conn.query(sql2, [name])];
                    case 3:
